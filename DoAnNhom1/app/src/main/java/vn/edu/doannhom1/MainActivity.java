...
import vn.edu.doannhom1.Activity.CartActivity;
import vn.edu.doannhom1.Activity.MyOrdersActivity;
import vn.edu.doannhom1.Activity.ProductsActivity;
import vn.edu.doannhom1.Adapter.HomeSliderAdapter;
import vn.edu.doannhom1.Adapter.ItemAdapter;
...
import vn.edu.doannhom1.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private Integer[] images = {R.drawable.slide1, R.drawable.slide2, R.drawable.slide4};
    Timer timer;
    int page_position = 0;
...
//            }
//        });
        binding.iphone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, ProductsActivity.class)
                        .putExtra("cat","iphone"));
        ...
        binding.redmi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, ProductsActivity.class)
                        .putExtra("cat","redmi"));
        ...
        binding.levono.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, ProductsActivity.class)
                        .putExtra("cat","levono"));
                ...
                AuthUI.getInstance()
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                Intent intent1 = new Intent(MainActivity.this, ReferenceActivity.class);
