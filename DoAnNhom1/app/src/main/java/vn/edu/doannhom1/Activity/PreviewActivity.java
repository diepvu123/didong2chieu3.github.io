package vn.edu.doannhom1.Activity;

import static vn.edu.doannhom1.Adapter.ItemAdapter.list;
...
import vn.edu.doannhom1.BuildConfig;
import vn.edu.doannhom1.Model.ItemModel;
import vn.edu.doannhom1.R;
import vn.edu.doannhom1.databinding.ActivityPreviewBinding;
...
public class PreviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.itemWeight.setText(model.getItemCapacity());
...
//        getShopDetails();
        ...
        binding.apvShare.setOnClickListener(view -> {
            try {
                ...
                startActivity(Intent.createChooser(shareIntent, "chọn một"));
            } catch(Exception e) {
                //e.toString();
                e.printStackTrace();
            }
...
//    }
    ...
    private void addCart(ItemModel model) {
        ...
        map.put("quantity",1);
        map.put("itemCapacity",model.getItemCapacity());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    if (snapshot.child(user.getUid()).exists()){
                        ...
                        lyt.setTag("not");
                        txtCart.setText("Thêm vào giỏ hàng");
